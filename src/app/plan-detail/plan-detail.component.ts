...
//          this.plan.parkingOutdoor = 0;
       ...
       this.planhistory = values[6];
       this.planhistory.forEach(me => {
         me['historyPjCost'] = this.getHistoryPjCost(me);
       });
      }
...
*/
  ...
  getHistoryPjCost(plan: Planinfohistory) {
    let ret = 0;
